...
class ProductoAdmin(admin.ModelAdmin):
    list_display = ['plu_codigo','stock','precio','preciooferta','nombre','marca','descripcion','tipo','imagen','fecha_ingreso'] #mostrar el producto ordenado por sus caracteristicas
